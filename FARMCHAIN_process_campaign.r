...
#### itermediate step to circumvent calibration
skip_calibration <- function(dt) {
  dt[, CH4_dry_cal := CH4_dry]
  dt[, CO2_dry_cal := CO2_dry]
  dt[, NH3_dry_cal := NH3]
  dt[, N2O_dry_cal := N2O_dry]
}
...
plot_barn_bgd_change <- function(dt, gas = 'NH3', bgd_pos, max_time = 15, sampling_pos = 1) {
